...
minimum number of years (`cv-req:MinimumYearsExperience`) and a maximum number of years (`cv-req:MaximumYearsExperience`). The candidate must fulfill
...
<2> Project experience requirement - indicate whether a candidate needs to fulfill the project requirement. According to codelist Requirement code
<3> Type of project experience according to codelist Classification of Occupations (Styrk98)
...
<10> Role in project according to codelist Classification of Occupations (Styrk98)
...
<14> Project value in money. Currency according to code list ISO 4217 Currency codes
...
<3> Type of project experience according to codelist Classification of Occupations (Styrk98)
<4> Type of industry according to codelist Classification of standard industrial classification (NACE)
<5> Workplace according to code list ISO 3166-1:Alpha2 Country codes
<6> Job sector (private, public or other)
<7> Total year of experience
<8> Period for the experience
<9> Candidate's position percent
...
----
<1> Project experience identifier
<2> Type of project experience according to codelist Classification of Occupations (Styrk98)
<3> Type of industry according to codelist Classification of standard industrial classification (NACE)
<4> Workplace according to code list ISO 3166-1:Alpha2 Country codes
<5> Job sector (private, public or other)
<6> Company information
<7> Period for the experience
<8> Position percent in the project
<9> Role in project according to codelist Classification of Occupations (Styrk98)
...
<13> Project value in money. Currency according to code list ISO 4217 Currency codes
