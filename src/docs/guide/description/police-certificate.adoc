...
<2> Certificate requirement - indicates whether a candidate needs to fulfill the requirement.  According to codelist Requirement code
<3> Certificate type according to code list Police certificate
...
----
<1> Police certificate identifier.
<2> Certificate type according to code list Police certificate
