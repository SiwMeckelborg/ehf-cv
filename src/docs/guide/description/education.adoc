...
<2> Education requirement - indicate whether a candidate needs to fulfill the educational requirement. According to codelist Requirement code
<3> Education title in freetext
<4> Education degree according to codelist Education degree
...
<2> Education requirement - indicate whether a candidate needs to fulfill the educational requirement. According to codelist Requirement code
<3> Education title in freetext
<4> Relevant experience type according to codelist Classification of Occupations (Styrk98)
...
<3> Education degree according to code list Education degree
<4> Education period
